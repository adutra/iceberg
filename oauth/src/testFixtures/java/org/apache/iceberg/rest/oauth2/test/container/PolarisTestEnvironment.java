...
import org.apache.iceberg.rest.oauth2.test.ImmutableTestEnvironment.Builder;
import org.apache.iceberg.rest.oauth2.test.TestConstants;
import org.apache.iceberg.rest.oauth2.test.TestEnvironment;
import org.apache.iceberg.rest.oauth2.test.TestEnvironmentExtension;
    ...
    PolarisContainer polaris =
        new PolarisContainer()
            .withEnv(
                ...
                TestConstants.ACCESS_TOKEN_LIFESPAN.toString());
    polaris.start();
    context
