...
class TestDeviceAccessTokenRequest {
  ...
  public static Stream<Arguments> asFormParameters() {
    return Stream.of(
        Arguments.of(
            ...
            Map.of(
                "grant_type", GrantType.DEVICE_CODE.canonicalName(), "device_code", "deviceCode1")),
        Arguments.of(
            DeviceAccessTokenRequest.builder()
                ...
                .build(),
            Map.of(
                "grant_type", GrantType.DEVICE_CODE.canonicalName(),
                "client_id", "client1",
