...
class TestClientCredentialsTokenRequest {
  ...
  public static Stream<Arguments> asFormParameters() {
    return Stream.of(
        Arguments.of(
            ...
            Map.of("grant_type", GrantType.CLIENT_CREDENTIALS.canonicalName())),
        Arguments.of(
            ClientCredentialsTokenRequest.builder()
                ...
                .build(),
            Map.of(
                "grant_type", GrantType.CLIENT_CREDENTIALS.canonicalName(),
                "scope", "scope1 scope2",
                "extra1", "value1",
                "extra2", "value2")));
  }
