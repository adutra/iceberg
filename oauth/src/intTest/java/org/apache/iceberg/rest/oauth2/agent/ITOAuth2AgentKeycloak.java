...
import static org.apache.iceberg.rest.oauth2.grant.GrantType.AUTHORIZATION_CODE;
import static org.apache.iceberg.rest.oauth2.grant.GrantType.DEVICE_CODE;
import static org.apache.iceberg.rest.oauth2.grant.GrantType.PASSWORD;
import static org.apache.iceberg.rest.oauth2.grant.GrantType.TOKEN_EXCHANGE;
...
import org.apache.iceberg.rest.oauth2.test.TestPemUtils;
import org.apache.iceberg.rest.oauth2.test.container.KeycloakTestEnvironment;
...
public class ITOAuth2AgentKeycloak {
  ...
  void fixedToken(ImmutableTestEnvironment.Builder envBuilder) {
    ...
    try (TestEnvironment env =
      ...
      // cannot fetch new tokens directly, as there are no client credentials available
      soft.assertThat(agent.fetchNewTokens())
          .completesExceptionallyWithin(Duration.ofSeconds(10))
          .withThrowableOfType(ExecutionException.class)
          .withCauseInstanceOf(IllegalArgumentException.class)
          .withMessageContaining(
              "Iceberg REST dialect initial token fetches require client_secret to be set");
    }
  }
