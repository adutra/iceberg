...
/**
 * A Client authentication method for clients in possession of a client password, using HTTP Basic
...
public abstract class ClientSecretBasicAuthenticator implements ClientSecretAuthenticator {
