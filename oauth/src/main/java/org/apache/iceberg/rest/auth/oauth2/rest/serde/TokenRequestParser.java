...
public abstract class TokenRequestParser {
  ...
  public static void writeJsonFields(TokenRequest request, JsonGenerator gen) throws IOException {
    Preconditions.checkArgument(null != request, "Invalid client credentials token request: null");

    ClientRequestParser.writeJsonFields(request, gen);
  ...
  public static <T extends TokenRequest, B extends TokenRequest.Builder<T, B>> void readJsonFields(
    ...
    ClientRequestParser.readJsonFields(json, builder);
