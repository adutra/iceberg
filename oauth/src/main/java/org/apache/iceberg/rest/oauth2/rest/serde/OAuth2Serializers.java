...
public final class OAuth2Serializers {
  ...
  public static void registerAll(ObjectMapper mapper) {
    ...
    module
        ...
        // Responses
        // TokenResponse
        .addSerializer(TokenResponse.class, new TokenResponseSerializer())
  ...
  // Request serializers and deserializers
  ...
  static class TokenResponseSerializer extends JsonSerializer<TokenResponse> {
    @Override
    public void serialize(TokenResponse request, JsonGenerator gen, SerializerProvider serializers)
        throws IOException {
      TokenResponseParser.toJson(request, gen);
    }
  }

  static class TokenResponseDeserializer extends JsonDeserializer<TokenResponse> {
    @Override
    public TokenResponse deserialize(JsonParser p, DeserializationContext context)
        throws IOException {
      JsonNode jsonNode = p.getCodec().readTree(p);
      return TokenResponseParser.fromJson(jsonNode);
    }
  }
