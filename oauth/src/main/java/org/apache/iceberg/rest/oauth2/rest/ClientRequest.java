...
public interface ClientRequest extends PostFormRequest {
  ...
  default Map<String, String> asFormParameters() {
    ...
    if (clientAssertion() != null) {
      data.put(CLIENT_ASSERTION, clientAssertion());
    }

    URI clientAssertionType = clientAssertionType();
    if (clientAssertionType != null) {
      data.put(CLIENT_ASSERTION_TYPE, clientAssertionType.toString());
    }
