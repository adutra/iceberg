...
public interface OAuth2AgentSpec {
  ...
  @Value.Default
  default ResourceOwnerPasswordConfig resourceOwnerConfig() {
  ...
  default OAuth2AgentSpec merge(Map<String, String> properties) {
    ...
    return builder()
        ...
        .resourceOwnerConfig(resourceOwnerConfig().merge(properties))
  ...
  interface Builder {
    ...
    default Builder from(Map<String, String> properties) {
      ...
      return basicConfig(BasicConfig.builder().from(properties).build())
          .resourceOwnerConfig(ResourceOwnerPasswordConfig.builder().from(properties).build())
    ...
    @CanIgnoreReturnValue
    Builder resourceOwnerConfig(ResourceOwnerPasswordConfig resourceOwnerPasswordConfig);
