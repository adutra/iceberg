...
public class TokenExchangeResponseParser {

  private static final String ISSUED_TOKEN_TYPE = "issued_token_type";

  private TokenExchangeResponseParser() {}

  public static String toJson(TokenExchangeResponse response) {
    return toJson(response, false);
  }

  public static String toJson(TokenExchangeResponse response, boolean pretty) {
    return JsonUtil.generate(gen -> toJson(response, gen), pretty);
  }

  public static void toJson(TokenExchangeResponse response, JsonGenerator gen) throws IOException {
  ...
  public static TokenExchangeResponse fromJson(String json) {
    return JsonUtil.parse(json, TokenExchangeResponseParser::fromJson);
  }

  public static TokenExchangeResponse fromJson(JsonNode json) {
    Preconditions.checkArgument(null != json, "Cannot parse token response from null object");

    TokenExchangeResponse.Builder builder = ImmutableTokenExchangeResponse.builder();
