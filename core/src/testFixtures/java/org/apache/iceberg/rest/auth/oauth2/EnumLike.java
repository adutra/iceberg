 ...
 * "Enum-like" type.
 *
 * <p>This annotation can be used with any type that exposes a set of static final constants, as
 * long as their {@code toString()} method returns the constant's canonical string representation.
 *
