...
@Value.Immutable
public abstract class MetadataDiscoveryExpectation extends ExpectationBase {
    ...
    if (testEnvironment().discoveryEnabled()) {
      ...
      ImmutableMap.Builder<String, Object> builder =
          ImmutableMap.<String, Object>builder()
              ...
              .put("authorization_endpoint", testEnvironment().authorizationEndpoint().toString())
              .put("token_endpoint", testEnvironment().tokenEndpoint().toString());
      if (testEnvironment().includeDeviceAuthEndpointInDiscoveryMetadata()) {
        builder.put(
            "device_authorization_endpoint",
            testEnvironment().deviceAuthorizationEndpoint().toString());
      }
