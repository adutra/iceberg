...
public class PolarisContainer extends GenericContainer<PolarisContainer> {
  ...
  public PolarisContainer withClient(String id, String secret) {
    this.clientId = id;
  ...
  @CanIgnoreReturnValue
  public PolarisContainer withAccessTokenLifespan(Duration lifespan) {
  ...
  public URI tokenEndpoint() {
    return catalogApiEndpoint().resolve("v1/oauth/tokens");
  }
