...
@Value.Immutable
abstract class ErrorExpectation extends BaseExpectation {

  static final ImmutableOAuth2Error OAUTH2_ERROR =
      ImmutableOAuth2Error.builder()
          .code("invalid_request")
          .description("Invalid request (MockServer Authorization Server)")
          .build();

  static final HttpResponse AUTHORIZATION_SERVER_ERROR_RESPONSE =
  ...
  static final HttpResponse CATALOG_SERVER_ERROR_RESPONSE =
      HttpResponse.response()
          .withStatusCode(401)
          .withContentType(MediaType.APPLICATION_JSON)
          .withBody(
