...
public abstract class TestEnvironment implements AutoCloseable {
  ...
  public SessionContext sessionContext() {
    return new SessionCatalog.SessionContext(
        ...
        Map.of(
            ...
            sessionContextGrantType().getValue(),
            BasicConfig.SCOPE,
  ...
  public HTTPClient httpClient() {
    ...
    TestTLSConfigurer.HOSTNAME_VERIFIER.set(sslHostnameVerifier());
    return builder.build();
  }
  ...
  public static class TestTLSConfigurer implements TLSConfigurer {
    ...
    private static final ThreadLocal<HostnameVerifier> HOSTNAME_VERIFIER = new ThreadLocal<>();
