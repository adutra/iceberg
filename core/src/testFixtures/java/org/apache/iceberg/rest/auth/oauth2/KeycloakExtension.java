...
class KeycloakExtension extends TestEnvironmentExtension
    implements BeforeAllCallback, AfterAllCallback, ParameterResolver {

  // Client1 is used for client_secret_basic and client_secret_post authentication
  static final String CLIENT_ID1 = TestEnvironment.CLIENT_ID1.getValue();
  static final String CLIENT_SECRET1 = TestEnvironment.CLIENT_SECRET1.getValue();
  static final String CLIENT_AUTH1 = ClientAuthenticationMethod.CLIENT_SECRET_BASIC.getValue();

  // Client2 is used for dynamic subject tokens
  static final String CLIENT_ID2 = TestEnvironment.CLIENT_ID2.getValue();
  static final String CLIENT_SECRET2 = TestEnvironment.CLIENT_SECRET2.getValue();
  static final String CLIENT_AUTH2 = ClientAuthenticationMethod.CLIENT_SECRET_BASIC.getValue();

  // Client3 is used for dynamic actor tokens
  static final String CLIENT_ID3 = "Client3";
  static final String CLIENT_SECRET3 = "s€cr€t";
  static final String CLIENT_AUTH3 = ClientAuthenticationMethod.CLIENT_SECRET_BASIC.getValue();

  // Client4 is used for "none" authentication (client)
  static final String CLIENT_ID4 = "Client4";
  static final String CLIENT_AUTH4 = ClientAuthenticationMethod.NONE.getValue();

  static final String USERNAME = TestEnvironment.USERNAME;
  static final String PASSWORD = TestEnvironment.PASSWORD.getValue();

  static final String SCOPE1 = TestEnvironment.SCOPE1.toString();
  static final String SCOPE2 = TestEnvironment.SCOPE2.toString();
  ...
  static final String AUDIENCE = CLIENT_ID1;
  ...
  protected ImmutableTestEnvironment.Builder newTestEnvironmentBuilder(ExtensionContext context) {
    ...
    return TestEnvironment.builder()
        ...
        // Token exchange audience & resource
