...
import org.apache.iceberg.rest.auth.oauth2.test.junit.HydraExtension;
...
public class ITOAuth2ClientHydraIT {
  ...
  void clientSecretBasic(
    ...
    try (TestEnvironment env =
            envBuilder
                ...
                .clientId(new ClientID(HydraExtension.CLIENT_ID1))
                .clientSecret(new Secret(HydraExtension.CLIENT_SECRET1))
                .build();
        OAuth2Client client = env.newClient()) {
      assertClient(client, HydraExtension.CLIENT_ID1);
    }
  }
  ...
  void clientSecretPost(
    ...
    try (TestEnvironment env =
            envBuilder
                ...
                .clientId(new ClientID(HydraExtension.CLIENT_ID2))
                .clientSecret(new Secret(HydraExtension.CLIENT_SECRET2))
                .build();
        OAuth2Client client = env.newClient()) {
      assertClient(client, HydraExtension.CLIENT_ID2);
    }
  }
  ...
  private void assertClient(OAuth2Client client, String clientId) throws Exception {
    // initial grant
